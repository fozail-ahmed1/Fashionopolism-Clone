...
function displayFeaturedMovie(movie, container) {
  ...
  featuredMovieContent.innerHTML = `
    ...
    <div class="featured-movie-content">
      ...
      <p class="featured-movie-date">Release Date: 12/08/2000 </p>
      <p class="featured-movie-details">In 1970s London amidst the punk rock revolution, a young grifter named Estella is determined to make a name for herself with her designs.</p>
      <p class="featured-movie-details">She befriends a pair of young thieves who appreciate her appetite for mischief, and together they are able to build a life for themselves on the London streets.</p>
